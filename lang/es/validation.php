...
|--------------------------------------------------------------------------
|
| El sitio está en español (`app.locale`) y también su idioma de respaldo, así
| que sin este archivo **todos** los errores de validación salían como la clave
| cruda: «validation.required», «validation.uploaded». Las claves son las que
| publica `php artisan lang:publish` para esta versión de Laravel.
|
| `custom` y `attributes` quedan vacíos a propósito: los mensajes propios de la
| aplicación se escriben en el `after()` de cada Form Request, donde se ve la
| regla que los motiva.
|
*/
...
return [
    ...
    'array_keys' => 'El campo :attribute solo debe contener estas claves: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña apareció en una filtración de datos. Elegí otra.',
    ],
